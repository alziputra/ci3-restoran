<div class="container shadow-container">
    <h2 class="p-2 text-center">Edit Restoran Kategori "<?php echo $cat['kategori_nama'];?>"</h2>
    <form action="<?php echo base_url().'admin/category/edit/'.$cat['kategori_id'];?>" class="container" method="POST" id="myForm">
        <div class="form-group">
            <label for="category">Kategori</label>
            <input type="text" class="form-control" id="category" placeholder="Enter Category" name="category" value="<?php echo set_value('category', $cat['kategori_nama']);?>">
