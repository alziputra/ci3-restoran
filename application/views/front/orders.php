<div class="container mt-3">
    ...
    <div class="container shadow-container">
        <h2 class="text-center">Terakhir Dipesan</h2>
            ...
            <table class="table table-bordered table-hover table-striped">
                ...
                <tbody id="myTable">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="javascript:void(0);" onclick="deleteOrder(<?php echo $order['order_id']; ?>)" class="btn btn-danger"><i class="fas fa-trash-alt"></i> Cancel</a>
                        </td>
                    </tr>
                    <?php } ?>
                    <?php } ?>
            ...
            <table class="table table-bordered table-hover table-striped">
                ...
                <tbody id="myTable">
                    ...
                    <tr>
                        ...
                        <td><a href="<?php echo base_url().'orders/invoice/'.$order['order_id']; ?>" class="btn btn-info"><i class="fas fa-file-alt"></i> Invoice</a></td>
                    </tr>
                    <?php } ?>
                    <?php } ?>
                    <?php } else { ?>
