...
class Home extends CI_Controller {
    ...
    public function index() {
        ...
        $restoranReport = $this->Admin_model->getRestoReport();
        $data['restoranReport'] = $restoranReport;
    ...
    public function restoranReport() {
        $restoranReport = $this->Admin_model->getRestoReport();
        $data['restoranReport'] = $restoranReport;
    ...
    public function generate_pdf($id) {
        ...
        if($id == 1) {
            ...
            foreach ($restoranReport as $sf):
                $this->table->add_row($sf->resto_id, $sf->nama_resto, $sf->harga);
            endforeach; 
            ...
            foreach ($dishReport as $sf):
                $this->table->add_row($sf->menu_id, $sf->nama_menu, $sf->qty);
            endforeach;
